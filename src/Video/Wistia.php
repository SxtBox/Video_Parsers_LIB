 ...
 *
 */
class Wistia extends \Video_Parsers\Video {
     ...
     * @return  \Video_Parsers\Video\Wistia          The instance of this, to make chaining possible
     */
    ...
    protected function videoApiInformation() {
        ...
        // if the api information is known already for URL, return it
        if (isset($this->apiInformation[md5($url)])) {
            return $this->apiInformation[md5($url)];
        }
        
        // done, return Video information
